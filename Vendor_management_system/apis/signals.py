...
print(f"inside signals.py file")

def create_historical_performance(vendor):
    print("inside create historical performance 1 signal---------------")
    ...
    print(f"vender------------>{vendor.fulfillment_rate}")
    print("inside create historical performance signal 1 completed---------------")
...
def calculate_on_time_delivery_rate(sender, instance, **kwargs):
    print(f"inside calculate_on_time_delivery_rate 2 signal ----------------")
    ...
    print(f"inside calculate_on_time_delivery_rate signal 2 completed----------------")
...
def calculate_quality_rating_avg(sender, instance, **kwargs):
    print(f"inside calculate_quality_rating_avg signal  3 ----------------")
    ...
    print(f"inside calculate_quality_rating_avg signal 3 completed----------------")
...
def calculate_average_response_time(sender, instance, **kwargs):
    print(f"inside calculate_average_response_time signal 4 ----------------")
    ...
    if instance.status == 'acknowledged' and instance.acknowledgment_date:
        ...
        vendor.save()
        create_historical_performance(vendor)
    print(f"inside calculate_average_response_time signal 4 completed----------------")
...
def calculate_fulfillment_rate(sender, instance, **kwargs):
    print(f"inside calculate_fulfillment_rate signal 5 ----------------")
    ...
    vendor.save()
    create_historical_performance(vendor)
    print(f"inside calculate_fulfillment_rate signal completed 5 ----------------")
post_save.connect(calculate_fulfillment_rate,sender=PurchaseOrder)

def post_fun(sender , instance , **kwargs):
    print(f"post signal triggered inside signals.py ")

post_save.connect(post_fun,sender=Item)